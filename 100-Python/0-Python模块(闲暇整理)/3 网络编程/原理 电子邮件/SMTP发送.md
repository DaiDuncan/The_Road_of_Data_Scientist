...
![image-20210131151431179](https://cdn.jsdelivr.net/gh/DaiDuncan/PicUploader/img/20210131151431.png)
...
你看到的收件人的名字很可能不是我们传入的`管理员`，因为很多邮件服务商在显示邮件时，会==把收件人名字自动替换为用户注册的名字==，但是其他收件人名字的显示不受影响。
